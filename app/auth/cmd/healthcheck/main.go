// Command healthcheck is a minimal Docker HEALTHCHECK probe for the
// authz container. It issues a GET request to a URL and exits 0 if the
...
const (
	defaultURL = "http://localhost:8080/.well-known/openid-configuration"
