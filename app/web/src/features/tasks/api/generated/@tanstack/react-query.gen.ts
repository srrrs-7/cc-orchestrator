...
export const getTasksInfiniteOptions = (options?: Options<GetTasksData>) => {
  const opts = infiniteQueryOptions<GetTasksResponse, GetTasksError, InfiniteData<GetTasksResponse>, QueryKey<Options<GetTasksData>>, number | Pick<QueryKey<Options<GetTasksData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
